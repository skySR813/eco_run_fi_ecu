...
int input_B = 3;
int btn_1 = 8;
int serial_1_TX = 0;//メインサブ通信用
int serial_1_RX = 1;//メインサブ通信用
...
void setup() {
  ...
  //メインに初期値送信(シリアル1)
  ////////////////////////////
  Serial1.print("<SET:main=");
  Serial1.print(counter_main,3);
  Serial1.println(">");
  delay(1);

  Serial1.print("<SET:fuel1=");
  Serial1.print(counter_fuel1,3);
  Serial1.println(">");
  delay(1);

  Serial1.print("<SET:fuel2=");
  Serial1.print(counter_fuel2,3);
  Serial1.println(">");
  delay(1);

  Serial1.print("<SET:ign1=");
  Serial1.print(counter_ign1,3);
  Serial1.println(">");
  delay(1);

  Serial1.print("<SET:ign2=");
  Serial1.print(counter_ign2,3);
  Serial1.println(">");
  /////////////////////////////
  //
  /////////////////////////////
...
void showScreen() {
  ...
  //eepromではなくpicoに付属するのフラッシュメモリに保存します。保存回数に注意！！
  //デバッグ用と送信用
